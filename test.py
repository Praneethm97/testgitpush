...
#this data is called as document
data = {
    "name":"praneeth",
    "mail_id": "mpr@gmail.com",
...
database = client['myinfo'] #db created
#inside db we need to create collection >> collection is nothing but like a table i.e bunch of documents
...
record = collection.find() #extract all data
for i in record:
    print(i)
